...
openssl req -config openssl-intermediate-ca.cnf -extensions server_cert \
        ...
        -addext "subjectAltName = DNS:kafka1-01103,DNS:kafka2-01103,DNS:kafka1-111,DNS:kafka2-111,DNS:kafka1-282,DNS:kafka2-282,DNS:kafka1-361,DNS:kafka2-361" \
...
openssl req -config openssl-intermediate-ca.cnf -extensions server_cert \
        ...
        -addext "subjectAltName = DNS:zookeeper-01103,DNS:zookeeper-111,DNS:zookeeper-282,DNS:zookeeper-361" \
